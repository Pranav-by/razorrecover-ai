...
const DEMO_SCENARIOS: ScenarioDemo[] = [
  {
    ...
    subtitle: 'High-probability temporary network timeout during UPI authorization',
    tag: 'Auto-Recovered',
    tagColor: 'green',
    amount: '₹6,999',
    ...
    riskReason: 'Bank UPI gateway timeout during peak authorization window (91% winback probability)',
    agentDecision: 'Strategy: retry_payment → Policy: Passed (₹6,999 ≤ ₹10,000 auto limit) → Verified Won Back',
  ...
  },
  {
    ...
    riskReason: 'Customer initiated checkout, opened payment sheet, and left due to distraction',
    agentDecision: 'Strategy: generate_link → Compliance: Passed (IST 11:30) → Link Sent & Converted',
  ...
  },
  {
    ...
    agentDecision: 'Strategy: send_reminder → Smart dunning step 2 → Promise to Pay logged for Sept 2',
  ...
  },
  {
    ...
    agentDecision: 'AI recommended retry → Policy Engine BLOCKED (Rule POL-02 & POL-05) → Routed to Human Review',
  ...
  },
  {
    ...
    agentDecision: 'Stopping Rules checked FIRST → Halted (Rule STOP-02) → 0 messages sent',
